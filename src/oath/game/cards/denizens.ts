...
export const denizenData: Record<string, DenizenData> = {
    ...
    VowOfKinship:       [OathSuit.Nomad,    [VowOfKinship, VowOfKinshipWhenPlayed],                 CardRestriction.Adviser, true],
