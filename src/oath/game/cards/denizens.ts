...
export const edificeData: Record<string, [string, OathSuit, string, Constructor<OathPower<Edifice>>[]]> = {
    FestivalDistrict:   ["SqualidDistrict",     OathSuit.Discord,  "Festival District",    []],
    SqualidDistrict:    ["FestivalDistrict",    OathSuit.None,     "Squalid District",     []],
    GreatSpire:         ["FallenSpire",         OathSuit.Arcane,   "Great Spire",          []],
    FallenSpire:        ["GreatSpire",          OathSuit.None,     "Fallen Spire",         []],
    SprawlingRampart:   ["BanditRampart",       OathSuit.Order,    "Sprawling Rampart",    []],
    BanditRampart:      ["SprawlingRampart",    OathSuit.None,     "Bandit Rampart",       []],
    HallOfDebate:       ["HallOfMockery",       OathSuit.Hearth,   "Hall of Debate",       []],
    HallOfMockery:      ["HallOfDebate",        OathSuit.None,     "Hall of Mockery",      []],
    ForestTemple:       ["RuinedTemple",        OathSuit.Beast,    "Forest Temple",        []],
    RuinedTemple:       ["ForestTemple",        OathSuit.None,     "Ruined Temple",        []],
    AncientForge:       ["BrokenForge",         OathSuit.Nomad,    "Ancient Forge",        []],
    BrokenForge:        ["AncientForge",        OathSuit.None,     "Broken Forge",         []]
}