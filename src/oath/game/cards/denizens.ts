...
export const denizenData: Record<string, DenizenData> = {
    ...
    AncientBloodline:   [OathSuit.Nomad,    [AncientBloodlineAction, AncientBloodlineEffect, AncientBloodlineRelics], CardRestriction.Adviser],
    ...
    VowOfKinship:       [OathSuit.Nomad,    [VowOfKinshipGain, VowOfKinshipGive, VowOfKinshipWhenPlayed],   CardRestriction.Adviser, true],
