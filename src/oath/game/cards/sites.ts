...
export const sitesData: Record<SiteName, [number, SitePowerName[], number?, ResourceCost?, OathSuit?, [OathResourceType, number][]?]> = {
    ...
    AncientCity:    [2, ["AncientCity", "AncientCityOff", "AncientCityOn"],             1, new ResourceCost([[Favor, 3]]),      OathSuit.Order],
    DeepWoods:      [2, ["DeepWoods", "DeepWoodsOff", "DeepWoodsOn"],                   1, new ResourceCost([], [[Secret, 2]])],
    FertileValley:  [3, ["FertileValley", "FertileValleyOff", "FertileValleyOn"]],
    StandingStones: [2, ["StandingStones", "StandingStonesOff", "StandingStonesOn"],    1, new ResourceCost([[Favor, 3]]),      OathSuit.Arcane],
    Steppe:         [2, ["Steppe", "SteppeOff", "SteppeOn"],                            1, new ResourceCost([[Favor, 3]]),      OathSuit.Nomad],
    Wastes:         [1, ["Wastes", "WastesOff", "WastesOn"],                            1, new ResourceCost([], [[Secret, 2]])],
